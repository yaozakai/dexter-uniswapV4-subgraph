...
export function getSubgraphConfig(): SubgraphConfig {
  ...
  if (selectedNetwork == SEPOLIA_NETWORK_NAME) {
    ...
    return {
      ...
      stablecoinWrappedNativePoolId: '0x000000',
      stablecoinIsToken0: true,
      wrappedNativeAddress: '0x4200000000000000000000000000000000000006', // WETH
      minimumNativeLocked: BigDecimal.fromString('1'),
      stablecoinAddresses: [
    ...
    return {
      ...
      stablecoinWrappedNativePoolId: '0xdd466e674ea557f56295e2d0218a125ea4b4f0f6f3307b95f85e6110838d6438', // https://etherscan.io/tx/0x5205439b7e71dfe27d0911a0b05c0380e481ae83bed1ec7025513be0e3eaecb7
      stablecoinIsToken0: false,
      wrappedNativeAddress: '0x0000000000000000000000000000000000000000', // Native ETH since above pool is a ETH/USDC pool
      minimumNativeLocked: BigDecimal.fromString('1'),
      stablecoinAddresses: [
