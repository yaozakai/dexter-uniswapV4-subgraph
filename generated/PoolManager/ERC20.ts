...
export class ERC20 extends ethereum.SmartContract {
  ...
  decimals(): BigInt {
    const result = super.call('decimals', 'decimals():(uint32)', [])

    return result[0].toBigInt()
  }

  try_decimals(): ethereum.CallResult<BigInt> {
    const result = super.tryCall('decimals', 'decimals():(uint32)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    const value = result.value
  ...
  balanceOf(_owner: Address): BigInt {
    const result = super.call('balanceOf', 'balanceOf(address):(uint256)', [ethereum.Value.fromAddress(_owner)])

    return result[0].toBigInt()
  }

  try_balanceOf(_owner: Address): ethereum.CallResult<BigInt> {
    const result = super.tryCall('balanceOf', 'balanceOf(address):(uint256)', [ethereum.Value.fromAddress(_owner)])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    const value = result.value
